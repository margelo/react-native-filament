 ...
 * ```
 */
const createChoreographer = () =>
  runOnRuntimeAsync(FilamentWorkletRuntime, () => {
    'worklet'
...
export function FilamentScene({ children, fallback, config, backend, frameRateOptions, ...viewProps }: FilamentProviderProps) {
  ...
  const choreographer = useDisposableResource(createChoreographer)
