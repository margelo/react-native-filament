...
import type { PointerHolder } from './PointerHolder.nitro'
import type { RenderableManager } from './RenderableManager.nitro'
import type { FilamentBuffer } from './FilamentBuffer.nitro'
