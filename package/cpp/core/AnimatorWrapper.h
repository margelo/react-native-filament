...
public:
  explicit AnimatorWrapper(std::shared_ptr<FilamentAsset> asset)
  ...
  explicit AnimatorWrapper(std::shared_ptr<FilamentAsset> asset, Animator* optionalAnimator) : AnimatorWrapper(asset) {
