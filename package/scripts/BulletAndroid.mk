...
# Disable profiling to avoid thread-local storage issues with NDK 27
# Enable emulated TLS for all architectures to avoid __tls_get_addr linker errors
LOCAL_CFLAGS := $(LOCAL_C_INCLUDES:%=-I%) -DBT_THREADSAFE -DSCE_PFX_USE_SIMD_VECTORMATH -DBT_NO_PROFILE
# TODO: When we bump the mind SDK to >= 29, we can remove -femulated-tls
LOCAL_CFLAGS += -femulated-tls

LOCAL_CFLAGS += -ffast-math -funsafe-math-optimizations
...
# Only apply ARM32-specific flags for armeabi-v7a (NDK 27+ compatibility)
