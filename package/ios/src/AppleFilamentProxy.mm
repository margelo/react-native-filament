...
std::shared_ptr<FilamentRecorder> AppleFilamentProxy::createRecorder(int width, int height, int fps) {
  std::shared_ptr<AppleFilamentRecorder> recorder = std::make_shared<AppleFilamentRecorder>(width, height, fps);
