...
template <typename U> inline constexpr U min(U a, U b) noexcept {
  return a < b ? a : b;
}

template <typename U> inline constexpr U max(U a, U b) noexcept {
  return a > b ? a : b;
}

template <typename T, typename U> struct arithmetic_result {
  using type = decltype(std::declval<T>() + std::declval<U>());
};

template <typename T, typename U> using arithmetic_result_t = typename arithmetic_result<T, U>::type;

template <typename A, typename B = int, typename C = int, typename D = int>
using enable_if_arithmetic_t =
    std::enable_if_t<is_arithmetic<A>::value && is_arithmetic<B>::value && is_arithmetic<C>::value && is_arithmetic<D>::value>;
...
public:
   ...
   * element type.
   */
  template <typename U> constexpr VECTOR<T>& operator+=(const VECTOR<U>& v) {
  ...
  template <typename U, typename = enable_if_arithmetic_t<U>> constexpr VECTOR<T>& operator+=(U v) {
...
private:
  ...
  template <typename U>
  friend inline constexpr VECTOR<arithmetic_result_t<T, U>> MATH_PURE operator+(const VECTOR<T>& lv, const VECTOR<U>& rv) {
  ...
  friend inline constexpr VECTOR<arithmetic_result_t<T, U>> MATH_PURE operator+(const VECTOR<T>& lv, U rv) {
    return lv + VECTOR<U>(rv);
  }

  template <typename U, typename = enable_if_arithmetic_t<U>>
  friend inline constexpr VECTOR<arithmetic_result_t<T, U>> MATH_PURE operator+(U lv, const VECTOR<T>& rv) {
...
template <template <typename T> class VECTOR, typename T> class TVecProductOperators {
public:
  /* compound assignment from a another vector of the same size but different
   * element type.
   */
 ...
 */
template <template <typename T> class VECTOR, typename T> class TVecUnaryOperators {
public:
 ...
 * get all the functionality here.
 */
template <template <typename T> class VECTOR, typename T> class TVecComparisonOperators {
private:
  /*
   * NOTE: the functions below ARE NOT member methods. They are friend functions
   * with they definition inlined with their declaration. This makes these
   ...
   * (the first one, BASE<T> being known).
   */
  template <typename U> friend inline constexpr bool MATH_PURE operator==(const VECTOR<T>& lv, const VECTOR<U>& rv) {
  ...
  template <typename U> friend inline constexpr VECTOR<bool> MATH_PURE equal(const VECTOR<T>& lv, const VECTOR<U>& rv) {
    VECTOR<bool> r{};
    for (size_t i = 0; i < lv.size(); i++) {
      r[i] = lv[i] == rv[i];
    }
  ...
  template <typename U> friend inline constexpr VECTOR<bool> MATH_PURE notEqual(const VECTOR<T>& lv, const VECTOR<U>& rv) {
    VECTOR<bool> r{};
    for (size_t i = 0; i < lv.size(); i++) {
      r[i] = lv[i] != rv[i];
    }
  ...
  template <typename U> friend inline constexpr VECTOR<bool> MATH_PURE lessThan(const VECTOR<T>& lv, const VECTOR<U>& rv) {
    VECTOR<bool> r{};
    for (size_t i = 0; i < lv.size(); i++) {
      r[i] = lv[i] < rv[i];
    }
  ...
  template <typename U> friend inline constexpr VECTOR<bool> MATH_PURE lessThanEqual(const VECTOR<T>& lv, const VECTOR<U>& rv) {
    VECTOR<bool> r{};
    for (size_t i = 0; i < lv.size(); i++) {
      r[i] = lv[i] <= rv[i];
    }
  ...
  template <typename U> friend inline constexpr VECTOR<bool> MATH_PURE greaterThan(const VECTOR<T>& lv, const VECTOR<U>& rv) {
    VECTOR<bool> r;
    for (size_t i = 0; i < lv.size(); i++) {
      r[i] = lv[i] > rv[i];
    }
  ...
  template <typename U> friend inline VECTOR<bool> MATH_PURE greaterThanEqual(const VECTOR<T>& lv, const VECTOR<U>& rv) {
    VECTOR<bool> r{};
    for (size_t i = 0; i < lv.size(); i++) {
      r[i] = lv[i] >= rv[i];
    }
...
private:
   ...
   * (the first one, BASE<T> being known).
   */
  template <typename U> friend constexpr inline arithmetic_result_t<T, U> MATH_PURE dot(const VECTOR<T>& lv, const VECTOR<U>& rv) {
  ...
  template <typename U> friend inline constexpr arithmetic_result_t<T, U> MATH_PURE distance(const VECTOR<T>& lv, const VECTOR<U>& rv) {
    return length(rv - lv);
  }

  template <typename U> friend inline constexpr arithmetic_result_t<T, U> MATH_PURE distance2(const VECTOR<T>& lv, const VECTOR<U>& rv) {
  ...
  template <typename U> friend inline VECTOR<T> MATH_PURE fmod(VECTOR<T> const& x, VECTOR<U> const& y) {
    VECTOR<T> r;
    for (size_t i = 0; i < r.size(); i++) {
  ...
  template <typename U> friend inline VECTOR<T> MATH_PURE remainder(VECTOR<T> const& x, VECTOR<U> const& y) {
    VECTOR<T> r;
    for (size_t i = 0; i < r.size(); i++) {
  ...
  template <typename U> friend inline VECTOR<T> MATH_PURE remquo(VECTOR<T> const& x, VECTOR<U> const& y, VECTOR<int>* q) {
    VECTOR<T> r;
    for (size_t i = 0; i < r.size(); i++) {
