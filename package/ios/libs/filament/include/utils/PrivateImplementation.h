 ...
 */
template <typename T> class PrivateImplementation {
public:
  ...
  template <typename... ARGS> explicit PrivateImplementation(ARGS&&...) noexcept;
  ...
  PrivateImplementation(PrivateImplementation&& rhs) noexcept : mImpl(rhs.mImpl) {
    rhs.mImpl = nullptr;
  }
