...
namespace details {
  ...
  template <typename T> constexpr inline T popcount(T v) noexcept {
  ...
  template <typename T, typename = std::enable_if_t<std::is_unsigned<T>::value>> constexpr inline T clz(T x) noexcept {
  ...
  template <typename T, typename = std::enable_if_t<std::is_unsigned<T>::value>> constexpr inline T ctz(T x) noexcept {
    ...
    if (sizeof(T) * CHAR_BIT >= 64) {
      if (x & T(0x00000000FFFFFFFF))
        c -= 32;
    }
    if (x & T(0x0000FFFF0000FFFF))
      c -= 16;
    if (x & T(0x00FF00FF00FF00FF))
      c -= 8;
    if (x & T(0x0F0F0F0F0F0F0F0F))
      c -= 4;
    if (x & T(0x3333333333333333))
      c -= 2;
    if (x & T(0x5555555555555555))
      c -= 1;
    return c;
  }
...
constexpr inline UTILS_PUBLIC UTILS_PURE unsigned int UTILS_ALWAYS_INLINE clz(unsigned int x) noexcept {
...
constexpr inline UTILS_PUBLIC UTILS_PURE unsigned long UTILS_ALWAYS_INLINE clz(unsigned long x) noexcept {
...
constexpr inline UTILS_PUBLIC UTILS_PURE unsigned long long UTILS_ALWAYS_INLINE clz(unsigned long long x) noexcept {
...
constexpr inline UTILS_PUBLIC UTILS_PURE unsigned int UTILS_ALWAYS_INLINE ctz(unsigned int x) noexcept {
...
constexpr inline UTILS_PUBLIC UTILS_PURE unsigned long UTILS_ALWAYS_INLINE ctz(unsigned long x) noexcept {
...
constexpr inline UTILS_PUBLIC UTILS_PURE unsigned long long UTILS_ALWAYS_INLINE ctz(unsigned long long x) noexcept {
...
constexpr inline UTILS_PUBLIC UTILS_PURE unsigned int UTILS_ALWAYS_INLINE popcount(unsigned int x) noexcept {
...
constexpr inline UTILS_PUBLIC UTILS_PURE unsigned long UTILS_ALWAYS_INLINE popcount(unsigned long x) noexcept {
...
constexpr inline UTILS_PUBLIC UTILS_PURE unsigned long long UTILS_ALWAYS_INLINE popcount(unsigned long long x) noexcept {
...
constexpr inline UTILS_PUBLIC UTILS_PURE uint8_t UTILS_ALWAYS_INLINE popcount(uint8_t x) noexcept {
...
constexpr inline UTILS_PUBLIC UTILS_PURE T log2i(T x) noexcept {
  return (sizeof(x) * 8 - 1u) - clz(x);
}

template <typename RandomAccessIterator, typename COMPARE>
inline UTILS_PUBLIC RandomAccessIterator partition_point(RandomAccessIterator first, RandomAccessIterator last, COMPARE pred,
