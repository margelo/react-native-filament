...
public:
   ...
   * @see Fov.
   */
  static math::mat4 projection(Fov direction, double fovInDegrees, double aspect, double near, double far = INFINITY);
   ...
   * @param far         distance in world units from the camera to the far plane. \p far > \p near.
   */
  static math::mat4 projection(double focalLengthInMillimeters, double aspect, double near, double far = INFINITY);
   ...
   * @see Fov.
   */
  void setProjection(double fovInDegrees, double aspect, double near, double far, Fov direction = Fov::VERTICAL);
   ...
   * @param far         distance in world units from the camera to the far plane. \p far > \p near.
   */
  void setCustomProjection(math::mat4 const& projection, math::mat4 const& projectionForCulling, double near, double far) noexcept;
   ...
   */
  void setCustomEyeProjection(math::mat4 const* UTILS_NONNULL projection, size_t count, math::mat4 const& projectionForCulling, double near,
                              double far);
   ...
   */
  void lookAt(math::double3 const& eye, math::double3 const& center, math::double3 const& up = math::double3{0, 1, 0}) noexcept;
