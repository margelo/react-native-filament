...
protected:
   ...
   */
  static Driver* UTILS_NULLABLE createDefaultDriver(OpenGLPlatform* UTILS_NONNULL platform, void* UTILS_NULLABLE sharedContext,
...
public:
   ...
   *
   */
  virtual SwapChain* UTILS_NONNULL createSwapChain(void* UTILS_NULLABLE nativeWindow, uint64_t flags) noexcept = 0;
   ...
   */
  virtual SwapChain* UTILS_NULLABLE createSwapChain(uint32_t width, uint32_t height, uint64_t flags) noexcept = 0;
   ...
   */
  virtual void makeCurrent(SwapChain* UTILS_NONNULL drawSwapChain, SwapChain* UTILS_NONNULL readSwapChain) noexcept = 0;
   ...
   */
  virtual void updateTexImage(Stream* UTILS_NONNULL stream, int64_t* UTILS_NONNULL timestamp) noexcept;
   ...
   */
  virtual bool setExternalImage(void* UTILS_NONNULL externalImage, ExternalTexture* UTILS_NONNULL texture) noexcept;
