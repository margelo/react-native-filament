...
public:
  ...
  public:
     ...
     */
    filament::Texture* operator()(filament::Texture const* equirectangular, filament::Texture* outCubemap = nullptr);
  ...
  public:
     ...
     */
    filament::Texture* operator()(Options options, filament::Texture const* environmentCubemap,
     ...
     */
    filament::Texture* operator()(filament::Texture const* environmentCubemap, filament::Texture* outIrradianceTexture = nullptr);
  ...
  public:
     ...
     * @return returns outReflectionsTexture
     */
    filament::Texture* operator()(filament::Texture const* environmentCubemap, filament::Texture* outReflectionsTexture = nullptr);
