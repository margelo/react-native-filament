...
class JFilamentRecorder : public jni::HybridClass<JFilamentRecorder>,
...
private:
  // JNI
  bool onReadyForMoreDataJava() { return onReadyForMoreData(); }
...
private:
  ...
  static auto constexpr kJavaDescriptor =
      "Lcom/margelo/filament/FilamentRecorder;";

public:
  explicit JFilamentRecorder(const jni::alias_ref<jhybridobject> &javaThis,
                             std::shared_ptr<Dispatcher> rendererDispatcher,
